...
function(bield_apply_linker_flags TARGET_NAME)
  ...
  if(BIELD_LINKER_FLAGS)
    set_target_properties(${TARGET_NAME}
      PROPERTIES LINK_FLAGS "${BIELD_LINKER_FLAGS}")
    bield_log(2 "Applying linker flags to '${TARGET_NAME}': ${BIELD_LINKER_FLAGS}")
  endif()
  ...
  foreach(CFG ${CMAKE_CONFIGURATION_TYPES})
    ...
    if(BIELD_LINKER_FLAGS_${CFG})
      set_target_properties(${TARGET_NAME}
        PROPERTIES LINK_FLAGS "${BIELD_LINKER_FLAGS_${CFG}}")
      bield_log(2 "Applying linker flags to '${TARGET_NAME}': ${BIELD_LINKER_FLAGS_${CFG}}")
    endif()
  endforeach()
