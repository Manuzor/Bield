...
function(bield_set_output_directories DIR_PREFIX)
  set(BIELD_OUTPUT_PREFIX_BIN "${BIELD_OUTPUT_DIR}/Bin/Linux${BIELD_GENERATOR_STRING}" PARENT_SCOPE)
  set(BIELD_OUTPUT_PREFIX_LIB "${BIELD_OUTPUT_DIR}/Lib/Linux${BIELD_GENERATOR_STRING}" PARENT_SCOPE)

  # Configuration neutral output directories.
  set(CMAKE_RUNTIME_OUTPUT_DIRECTORY "${BIELD_OUTPUT_DIR_BIN}/${DIR_PREFIX}${BIELD_ARCHITECTURE_STRING}${BIELD_GENERATOR_STRING}" PARENT_SCOPE)
  set(CMAKE_LIBRARY_OUTPUT_DIRECTORY "${BIELD_OUTPUT_DIR_LIB}/${DIR_PREFIX}${BIELD_ARCHITECTURE_STRING}${BIELD_GENERATOR_STRING}" PARENT_SCOPE)
  set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY "${BIELD_OUTPUT_DIR_LIB}/${DIR_PREFIX}${BIELD_ARCHITECTURE_STRING}${BIELD_GENERATOR_STRING}" PARENT_SCOPE)
  ...
  foreach(cfg ${CMAKE_CONFIGURATION_TYPES})
    ...
    set(CMAKE_RUNTIME_OUTPUT_DIRECTORY_${CFG} "${BIELD_OUTPUT_DIR_BIN}/${DIR_PREFIX}${BIELD_ARCHITECTURE_STRING}${BIELD_GENERATOR_STRING}${cfg}" PARENT_SCOPE)
    set(CMAKE_LIBRARY_OUTPUT_DIRECTORY_${CFG} "${BIELD_OUTPUT_DIR_LIB}/${DIR_PREFIX}${BIELD_ARCHITECTURE_STRING}${BIELD_GENERATOR_STRING}${cfg}" PARENT_SCOPE)
    set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY_${CFG} "${BIELD_OUTPUT_DIR_LIB}/${DIR_PREFIX}${BIELD_ARCHITECTURE_STRING}${BIELD_GENERATOR_STRING}${cfg}" PARENT_SCOPE)
